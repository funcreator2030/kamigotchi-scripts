...
(function () {
    ...
    log('%c✅ 轻量杀手监控-公开版 v1.2.1 已加载，等待启动...', 'font-size:16px;font-weight:bold;color:#fff;background:#2e7d32;padding:3px 10px;border-radius:4px');   // 🔻SYNC→内部版[1.1.14 启动横幅醒目化]
    ...
    // ============================================================
    console.log('═══════════════════════════════');
    console.log('%c🛡️ Kamigotchi轻量杀手监控-公开版 v1.2.1 已加载', 'color: green; font-weight: bold;');
    console.log('');
    console.log('【杀手监控优化】');
