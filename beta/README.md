...
| 脚本 | 版本 | 安装链接（点开即装） |
|---|---|---|
| Kamigotchi核心脚本-测试版 (core BETA) | `1.2.58` | https://raw.githubusercontent.com/funcreator2030/kamigotchi-scripts/main/beta/kamigotchi-core-beta.user.js |
| Kamigotchi辅助脚本-测试版 (helper BETA) | `1.2.16` | https://raw.githubusercontent.com/funcreator2030/kamigotchi-scripts/main/beta/kamigotchi-helper-beta.user.js |
