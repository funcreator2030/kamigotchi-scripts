...
| 脚本 | 版本 | 安装链接（点开即装） |
|---|---|---|
| Kamigotchi核心脚本-测试版 (core BETA) | `1.2.51` | https://raw.githubusercontent.com/funcreator2030/kamigotchi-scripts/main/beta/kamigotchi-core-beta.user.js |
...
| Kamigotchi轻量杀手监控-测试版 (killer BETA) | `1.2.13` | https://raw.githubusercontent.com/funcreator2030/kamigotchi-scripts/main/beta/kamigotchi-killer-monitor-beta.user.js |
